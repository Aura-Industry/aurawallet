...
For authentication details, see [AUTH.md](../ai-agents-workflow/AUTH.md).
...
> **Note**: Adding apps requires a token with `workspace:modify` permission or admin access. See [AUTH.md](../ai-agents-workflow/AUTH.md) for obtaining tokens.
...
> **Authentication Required**: All mutation events require a valid token with `workspace:modify` permission or admin access. Connect with `ws://localhost:4748?token=YOUR_TOKEN`. See [AUTH.md](../ai-agents-workflow/AUTH.md) for obtaining tokens.
